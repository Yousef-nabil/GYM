...
public class ViewMembers extends javax.swing.JFrame {
    ...
    public ViewMembers(ArrayList<String> m) throws FileNotFoundException {
        initComponents();
        populateTable(m);
      ...
      private void populateTable(ArrayList<String> m) {
        ...
        for(int i=0;i<SharedData.Members.size();i++)
        {String[] details = SharedData.Members.get(i).split(",");
             model.addRow(new Object[]{details[0], details[1], details[2], details[3], details[4], details[5]});
        }
    }
