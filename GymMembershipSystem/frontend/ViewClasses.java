...
public class ViewClasses extends javax.swing.JFrame {
     ...
     */
    public ViewClasses(ArrayList<String> m) {
        initComponents();
        populateTable(m);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Class Id", "Class name", "Trainer Id", "duration", "Macx participants"
            }
        ));
    ...
    private void populateTable(ArrayList<String> m) {
        ...
        for (String temp : m) {
         ...
         for(int i=0;i<SharedData.Classes.size();i++)
        {String[] details = SharedData.Classes.get(i).split(",");
             model.addRow(new Object[]{details[0], details[1], details[2], details[3], details[4]});
        }
    }
