...
import com.mycompany.integrationlab4.frontend.NewJFrame;
...
public class GymSystemExtendedTest {
    ...
    public static double testTrainerManagement() {
        ...
        double mark = 0;
        try {
            AdminRole admin = new AdminRole("D:\\College\\Term 5\\seif.txt");
            // Adding Trainer Test
    ...
    public static double testClassManagement() {
        ...
        try {
            ...
            Class  temp = (Class)trainer.getListOfClasses().get(0);
            boolean registered = trainer.registerMemberForClass(trainer.getListOfMembers().get(0).getSearchKey() , "C001", LocalDate.now());
            if (registered && temp.getAvailableSeats() == 0 && trainer.getListOfRegistrations().get(0).getSearchKey().equals("M001C001")) {
    ...
    public static double testRegistrationManagement() {
        ...
        try {
            ...
            Class temp2= (Class) trainer.getListOfClasses().get(1);
            if (cancelled && temp2.getAvailableSeats() == 30) {
